import { is_function, SvelteComponent, init, safe_not_equal, element, text, attr, insert, append, set_data, detach, create_slot, space, action_destroyer, update_slot_base, get_all_dirty_from_scope, get_slot_changes, transition_in, transition_out, destroy_each, component_subscribe, listen, run_all, set_store_value, binding_callbacks, create_component, mount_component, group_outros, destroy_component, check_outros, set_style, noop, empty } from 'svelte/internal';
import { getContext, onMount, onDestroy, createEventDispatcher, afterUpdate, tick, setContext } from 'svelte';
import { derived } from 'svelte/store';
import { createDuration, DAY_IN_SECONDS, addDuration, cloneDate, createDate, sortEventChunks, setContent, hasYScroll, toEventWithLocalDates, toViewWithLocalDates, createEventContent, setMidnight, createEventChunk, datesEqual, rect, toLocalDate, toISOString, addDay, height } from '@event-calendar/common';
...
function create_fragment$4(ctx) {
	...
	let if_block2 = /*$nowIndicator*/ ctx[10] && /*isToday*/ ctx[5] && create_if_block$2();
